...
namespace AutoScrewing.Lib
{
    public class MESHController
    {
        ...
        public MESHController(IHttpClientFactory _factory)
        {
            factory = _factory;
        ...
        public class MESH_HTTP_HANDLER : DelegatingHandler
        {
